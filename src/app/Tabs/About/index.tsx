  ...
  return (
    ...
    >
      <section className="bg-fg/35 relative inline-flex aspect-square size-full flex-col items-start overflow-hidden rounded-2xl p-4 text-xl drop-shadow-md">
        ...
        <h1 className="text-5xl text-shadow-md">Anvith Shenoy B</h1>
        <Image
          src={
      ...
      <section className="col-span-2 flex flex-col justify-start gap-5 divide-y">
        <div data-swapy-slot="intro">
          <div data-swapy-item="intro" className="space-y-1.5 py-2.5">
            ...
            <Card
              cardTitle={
                <div className="font-head text-title">
        ...
        <div className="grid w-full gap-4 divide-x sm:grid-cols-2">
          <div data-swapy-slot="difference">
            <div
            ...
            >
              <SwapyTitle
                ...
                clx="indent-0 ps-2 text-fg!"
              />

              <div className="group w-full gap-1.5">
                <p>
                  Feel great to have me on your team. Why? Because, when
                  it&apos;s me, it always all new all different.
                </p>
                <p>
                  <em>My Motto</em>
                  <strong>
                    When life&apos;s tough, you gotta get tougher!
                  </strong>
                </p>
              </div>
            </div>
          ...
          <div data-swapy-slot="contact">
            ...
            >
              ...
              <div className="group grid w-full grid-cols-3 gap-1.5 sm:grid-cols-6">
                <Link
                  href="mailto:anvithshenoyb@gmail.com"
                  className="card bg-title text-4xl"
                >
                  <span id="mailIcon">@</span>
                </Link>

                <Link
                  href={"https://linkedin.com/in/anvithshenoy/"}
                  className="card bg-[#0a66c2] text-4xl"
                >
                ...
                >
                  <span
                    id="GithubIcon"
                    className="overflow-hidden *:mx-auto *:aspect-square *:h-12 *:w-12 *:fill-[#ededf0]"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                >
                  <span
                    id="dribbleIcon"
                    className="overflow-hidden *:mx-auto *:aspect-square *:h-12 *:w-12"
                  >
                    <svg
                      viewBox="0 0 46 46"
                      version="1.1"
                ...
                <Link
                  ...
                  className="card bg-[#128c7e] font-sans *:fill-white"
                >
                  <span
                    id="whatsappIcon"
                    className="overflow-hidden *:mx-auto *:aspect-square *:h-12 *:w-12"
